...
describe("VariableForm", () => {
  ...
  it("should render all variable inputs", () => {
    ...
    expect(screen.getByPlaceholderText("Enter value for name")).toHaveAttribute(
      "type",
      "text"
    );
    expect(screen.getByPlaceholderText("Enter value for age")).toHaveAttribute(
      "type",
      "number"
    );
    expect(
      screen.getByPlaceholderText("Enter value for bio")
    ).toBeInTheDocument();
  ...
  it("should show empty state when no variables are provided", () => {
    ...
    expect(
      screen.getByText("Use {{ variable_name }} syntax to add variables")
    ).toBeInTheDocument();
  });
