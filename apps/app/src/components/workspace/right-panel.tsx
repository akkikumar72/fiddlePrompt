    ...
    <div className='h-full bg-muted/50 flex flex-col'>
      ...
      <div className='p-4 border-b border-border'>
        <div className='flex items-center justify-between'>
          <h2 className='font-semibold text-sm text-muted-foreground tracking-wide uppercase'>Test & Evaluate</h2>
                    ...
                    <div className='space-y-3'>
                      ...
                      <div className='flex items-center justify-between'>
                        <div className='flex items-center gap-2'>
                          ...
                          <span className='text-sm font-medium'>Run #{result.id}</span>
                        </div>
                      ...
                      {/* Output */}
                      <div className='text-sm leading-relaxed bg-muted/50 p-3 rounded-md'>{result.output}</div>
                    </div>
                  </Card>
                ))
              ) : (
              ...
              <div className='space-y-3'>
                ...
                {testCases.length === 0 && (
                  <div className='text-center py-8 text-muted-foreground'>
                    ...
                    <p className='text-xs'>Add test cases to evaluate your prompts</p>
                  </div>
                )}
              </div>
            </ScrollArea>
